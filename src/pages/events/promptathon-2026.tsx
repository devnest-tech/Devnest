  ...
  return (
    <div
      ...
      style={{
        filter: enlarging
          ? "none"
          : "sepia(1) hue-rotate(190deg) saturate(4) brightness(0.85)",
...
const StatCard = ({
  ...
  return (
    <motion.div
      className="bg-background/30 rounded-2xl sm:rounded-3xl p-5 sm:p-10 md:p-14 border-2 border-blue-400/30"
      style={{ opacity, scale }}
    >
      <div
...
export default function Promptathon2026Page() {
  ...
  useEffect(() => {
    const update = () =>
      setDomeRadius(window.innerWidth < 768 ? 260 : 600);
  ...
  const s1TitleOpacity = useTransform(
    section1Progress,
    [0, 0.2, 0.8, 1],
    [0, 1, 1, 0.3],
  );

  const s1TitleScale = useTransform(
    section1Progress,
    [0, 0.2],
    [0.8, 1],
  );

  const s1YearOpacity = useTransform(
    section1Progress,
    [0.2, 0.4],
    [0, 1],
  );
  ...
  const s2TitleOpacity = useTransform(
    section2Progress,
    [0, 0.15],
    [0, 1],
  );
  ...
  const s3TitleOpacity = useTransform(
    section3Progress,
    [0, 0.15],
    [0, 1],
  );

  const s3Stat1 = useTransform(
    section3Progress,
    [0.15, 0.3],
    [0, 1],
  );

  const s3Stat2 = useTransform(
    section3Progress,
    [0.25, 0.4],
    [0, 1],
  );

  const s3Stat3 = useTransform(
    section3Progress,
    [0.35, 0.5],
    [0, 1],
  );
  ...
  const s4IconOpacity = useTransform(
    section4Progress,
    [0, 0.2],
    [0, 1],
  );

  const s4TitleOpacity = useTransform(
    section4Progress,
    [0.2, 0.4],
    [0, 1],
  );
  ...
  return (
    ...
    >
      <Layout pauseTerminal customTheme="blue-gold">
        ...
        <div
          ref={containerRef}
          className="relative z-10 overflow-y-scroll h-screen pp-dvh"
            ...
            >
              <div className="text-center px-6">
                ...
                <motion.p
                  ...
                  style={{ opacity: s1TextOpacity }}
                >
                  <ScrollTypingText
                    text="Where words control intelligence..."
                    progress={section1Progress}
                    scrollRange={[0.4, 0.6]}
                    showCursor={true}
                  />
          ...
          <section className="h-[500vh] relative">
            ...
            >
              <div className="max-w-5xl w-full text-center pb-8">
                ...
                >
                  <span className="block text-center text-[3.5rem] sm:text-[8rem] leading-none font-black text-amber-400 tracking-tighter">
                    [WIN]
                  </span>
                </motion.div>
                ...
                >
                  {[
                    ...
                    },
                    {
                      ...
                      bg: "from-blue-300/15 to-blue-500/5",
                    },
                    {
                      medal: "🥉",
                      position: "3rd Place",
                    ...
                    <div
                      key={i}
                      className={`bg-gradient-to-br ${item.bg} rounded-2xl sm:rounded-3xl p-4 sm:p-6 border ${item.border} text-left`}
                    >
                      <div className="text-2xl sm:text-4xl mb-1 sm:mb-2">
                        <span className="emoji-white">
                          {item.medal}
                        </span>
                      </div>
                      ...
                      <div className="text-base sm:text-2xl font-black text-white mb-2 sm:mb-4">
                        {item.team}
                      </div>
                      ...
                      <ul className="space-y-0.5">
                        {item.members.map((member, index) => (
                          <li
                            key={index}
                            className="text-xs sm:text-sm text-blue-200/80 font-medium"
                          >
                            {member}
                          </li>
                        ))}
