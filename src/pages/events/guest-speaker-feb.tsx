        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6">
          ...
          <div className="glass-effect rounded-3xl border border-border/50 p-8 mb-8 text-center">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Thank you to everyone who attended our inspiring session with{" "}
              <span className="font-semibold text-foreground">
                Amit Kumar Jaiswal
              </span>
              , IIM Bangalore graduate and founder of{" "}
              <span className="font-semibold text-foreground">
                aptitude360online
              </span>
          ...
          <div className="glass-effect rounded-3xl border border-border/50 p-8 mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                {
                  src: "/events/guest-speaker-feb/image.png",
                  alt: "Guest Speaker Event - Session",
                },
                {
                  src: "/events/guest-speaker-feb/image1.png",
                  alt: "Guest Speaker Event - Audience",
                },
                {
                  src: "/events/guest-speaker-feb/image2.png",
                  alt: "Guest Speaker Event - Interaction",
                },
                {
                  src: "/events/guest-speaker-feb/image3.png",
                  alt: "Guest Speaker Event - Q&A",
                },
                {
                  src: "/events/guest-speaker-feb/image4.png",
                  alt: "Guest Speaker Event - Group Photo",
                },
              ].map((image, index) => (
                <div
                  key={index}
                  className={`relative overflow-hidden rounded-xl border border-border/50 hover:border-primary/50 transition-[border-color,transform] duration-150 hover:scale-[1.02] ${
          ...
          <div className="glass-effect rounded-3xl border border-border/50 bg-background/80 p-8 shadow-2xl">
            <h2 className="text-2xl sm:text-3xl font-poppins font-bold mb-6 text-center">
              About the Event
            </h2>
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    ...
                    <span className="text-xs">
                      IIM Bangalore Graduate • aptitude360online
                    </span>
                  </p>
                </div>
              </div>
